...
- The [AI software templates](https://github.com/gabemontero/rhdh-ai-template/tree/upd-model-catalog-new-entity), a collection of Software Templates based on AI applications.
